...
const subjects = [
  { id: 'anaesthesie', name: 'Anästhesie', color: '#8B3A2A', icon: 'Syringe', description: 'Narkose & Schmerztherapie' },
  { id: 'arbeitsmed', name: 'Arbeitsmedizin', color: '#6A92A8', icon: 'Briefcase', description: 'Arbeit & Gesundheit' },
  { id: 'augen', name: 'Augenheilkunde', color: '#8EBFB8', icon: 'Eye', description: 'Erkrankungen des Auges' },
  { id: 'chirurgie', name: 'Chirurgie', color: '#5C8E78', icon: 'Scissors', description: 'Operative Verfahren' },
  { id: 'derma', name: 'Dermatologie', color: '#DCA878', icon: 'Hand', description: 'Hauterkrankungen' },
  { id: 'allergo', name: 'Allergologie', color: '#C4C248', icon: 'Flower2', description: 'Allergien & Unverträglichkeiten' },
  { id: 'gyn', name: 'Gynäkologie', color: '#DF5280', icon: 'Baby', description: 'Frauenheilkunde & Geburtshilfe' },
  { id: 'hno', name: 'HNO', color: '#E0A030', icon: 'Ear', description: 'Hals, Nasen, Ohren' },
  { id: 'immuno', name: 'Immunologie', color: '#3C4858', icon: 'Shield', description: 'Immunsystem' },
  { id: 'infektio', name: 'Infektiologie', color: '#96A858', icon: 'Bug', description: 'Infektionskrankheiten' },
  { id: 'endo', name: 'Endokrinologie', color: '#C4A870', icon: 'Activity', description: 'Hormone & Stoffwechsel' },
  { id: 'gastro', name: 'Gastro', color: '#787838', icon: 'Utensils', description: 'Verdauungsorgane' },
  { id: 'hemato_onko', name: 'Hämato/Onko', color: '#E08888', icon: 'Droplet', description: 'Blut & Krebs' },
  { id: 'cardio', name: 'Kardiologie', color: '#C85030', icon: 'Heart', description: 'Herz & Kreislauf' },
  { id: 'nephro', name: 'Nephrologie', color: '#286070', icon: 'Waves', description: 'Nieren & Harnwege' },
  { id: 'pneumo', name: 'Pneumologie', color: '#BACAD8', icon: 'Wind', description: 'Lunge & Atmung' },
  { id: 'rheuma', name: 'Rheumatologie', color: '#BEB0CC', icon: 'Bone', description: 'Entzündliche Erkrankungen' },
  { id: 'intensiv', name: 'Intensiv & Notfall', color: '#C05A38', icon: 'Siren', description: 'Akutmedizin' },
  { id: 'neuro', name: 'Neurologie', color: '#6878A0', icon: 'Brain', description: 'Nervensystem' },
  { id: 'patho', name: 'Pathologie', color: '#A86040', icon: 'Microscope', description: 'Krankheitslehre' },
  { id: 'pharma', name: 'Pharmakologie', color: '#E8C860', icon: 'Pill', description: 'Arzneimittel' },
  { id: 'psych', name: 'Psychiatrie', color: '#CC5888', icon: 'BrainCircuit', description: 'Seelische Gesundheit' },
  { id: 'paedia', name: 'Pädiatrie', color: '#E8A080', icon: 'Smile', description: 'Kinderheilkunde' },
  { id: 'radio', name: 'Radiologie', color: '#788CA8', icon: 'Scan', description: 'Bildgebung' },
  { id: 'reha', name: 'Rehabilitation', color: '#8CB888', icon: 'Accessibility', description: 'Wiederherstellung' },
  { id: 'sozial', name: 'Sozialmedizin', color: '#A89898', icon: 'Users', description: 'Gesundheit & Gesellschaft' },
  { id: 'uro', name: 'Urologie', color: '#4A7888', icon: 'Droplets', description: 'Harnorgane & Genitalien' },
];
