    ...
    return (
      <div className="bg-white p-10 md:p-16 rounded-[48px] shadow-2xl space-y-10 max-w-4xl mx-auto border border-black/[0.02]">
        <div className="flex items-center justify-between border-b border-[#8B3E2F]/10 pb-8">
          <h1 className="text-5xl font-display text-[#8B3E2F] lowercase">karten: {activeSubject.name}</h1>
          <button 
            onClick={() => setView('setup')}
            className="px-6 py-2.5 bg-[#E2E8D4] rounded-full text-xs font-bold uppercase tracking-widest text-[#8B3E2F] hover:bg-[#8B3E2F] hover:text-white transition-all shadow-sm lowercase"
          >
            zurück
          </button>
        </div>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <div className="text-[10px] font-black text-[#8B3E2F]/30 uppercase tracking-[0.2em] lowercase">vorderseite</div>
                ...
                <div className="space-y-2 md:border-l md:pl-8 border-black/[0.05]">
                  <div className="text-[10px] font-black text-[#A3B18A] uppercase tracking-[0.2em] lowercase">antwort</div>
    ...
    return (
      <div className="w-full max-w-6xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h1 className="text-7xl text-[#8B3E2F] font-display lowercase">karteikarten</h1>
          <p className="text-xl text-[#4A3A2F]/40 font-medium font-sans max-w-2xl mx-auto italic leading-relaxed lowercase">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-8 space-y-8">
            ...
            <section className="bg-white p-10 rounded-[40px] shadow-xl border border-black/[0.02] space-y-8">
              <h2 className="text-3xl font-display text-[#8B3E2F] flex items-center gap-3 lowercase">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {subjects?.map(s => (
                  <button
                    ...
                    className={cn(
                      "p-6 rounded-[24px] border-2 transition-all text-base font-bold shadow-sm font-display tracking-wide text-left relative overflow-hidden group lowercase",
            ...
            <section className="bg-white p-10 rounded-[40px] shadow-xl border border-black/[0.02] space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 ...
                 >
                    <div className="flex items-center gap-2 text-[#A3B18A] font-bold uppercase tracking-widest text-[10px] lowercase">
                       <Clock className="w-3 h-3" /> fällige karten
                    </div>
                    <div className="text-2xl font-display text-[#4A3A2F] lowercase">intelligente wiederholung</div>
                    <p className="text-xs text-[#4A3A2F]/40 leading-relaxed font-sans lowercase">karten, die du laut sm-2 algorithmus heute wiederholen solltest.</p>
                 </button>
                 ...
                 >
                    <div className="flex items-center gap-2 text-[#8B1E1E] font-bold uppercase tracking-widest text-[10px] lowercase">
                       <Calendar className="w-3 h-3" /> alle karten
                    </div>
                    <div className="text-2xl font-display text-[#4A3A2F] lowercase">stapel durchblättern</div>
                    <p className="text-xs text-[#4A3A2F]/40 leading-relaxed font-sans lowercase">einfach alle karten des fachbereichs im schnelldurchlauf lernen.</p>
                 </button>
              </div>

              {studyMode === 'all' && (
                 <div className="pt-6 border-t border-black/[0.03] animate-in fade-in slide-in-from-top-2">
                    <h4 className="text-xs font-black uppercase tracking-widest text-[#4A3A2F]/40 mb-4 lowercase">portionsgröße</h4>
                    <div className="flex flex-wrap gap-2">
                       {[5, 10, 20, 50, 'all'].map(size => (
                          <button
                             ...
                             className={cn(
                                "px-6 py-2 rounded-full border-2 font-bold text-xs tracking-widest transition-all lowercase",
          ...
          <div className="lg:col-span-4">
            <div className="bg-white p-10 rounded-[40px] shadow-2xl border border-black/[0.01] sticky top-32 space-y-8 text-center overflow-hidden">
              ...
              <div className="space-y-2">
                 <h3 className="text-4xl font-display text-[#8B3E2F] lowercase">dein stapel</h3>
                 <p className="text-xs font-black uppercase tracking-widest text-[#4A3A2F]/30 lowercase">
              ...
              <div className="bg-[#E2E8D4]/50 p-6 rounded-3xl border border-black/[0.02]">
                 ...
                 <div className="text-[10px] font-black uppercase tracking-widest text-[#4A3A2F]/40 mt-1 lowercase">
              ...
              <div className="space-y-4 pt-4">
                <button
                  ...
                  className="w-full py-6 bg-[#8B1E1E] text-white rounded-[24px] font-display text-3xl shadow-xl hover:bg-[#763428] transition-all flex items-center justify-center gap-3 disabled:opacity-20 group lowercase"
                >
                  <span>starten</span>
                ...
                <button
                  ...
                  className="w-full py-2 text-[#4A3A2F]/30 font-bold text-[10px] uppercase tracking-widest hover:text-[#8B1E1E] transition-all flex items-center justify-center gap-2 disabled:opacity-0 lowercase"
                >
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <h2 className="text-5xl font-display text-[#8B1E1E] mb-3 lowercase">stapel gemeistert!</h2>
          <p className="text-lg text-[#4A3A2F]/40 mb-12 font-medium font-sans italic px-4 lowercase">"du hast heute {completedCount} karten gelernt. dein gehirn wird es dir danken!"</p>
          <div className="space-y-4">
            <button 
              onClick={() => setView('setup')} 
              className="w-full py-5 bg-[#8B1E1E] text-white rounded-2xl font-display text-2xl shadow-xl hover:bg-[#763428] transition-all lowercase"
            >
              nächste lerneinheit
            </button>
            <button 
              onClick={handleStartSession} 
              className="w-full py-3 text-[#4A3A2F]/30 font-bold text-xs hover:text-[#4A3A2F] transition-all uppercase tracking-widest lowercase"
            >
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-12 bg-white p-8 md:p-16 rounded-[48px] shadow-2xl border border-black/[0.02] relative overflow-hidden">
      ...
      <div className="flex items-center justify-between">
        <button 
          onClick={() => setView('setup')} 
          className="text-[10px] font-black uppercase tracking-widest text-[#4A3A2F]/30 hover:text-[#8B1E1E] transition-colors lowercase"
        >
          abbrechen
        </button>
        <div className="px-4 py-1 bg-[#E2E8D4] rounded-full text-xl font-display text-[#8B1E1E] lowercase">
           {currentIndex + 1} <span className="text-xs opacity-40 mx-1 lowercase">von</span> {sessionCards.length}
        </div>
      </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-auto">
                <div className="px-5 py-2 text-[10px] font-black uppercase tracking-widest text-white rounded-full shadow-sm lowercase" style={{ backgroundColor: activeSubject?.color }}>
                  {activeSubject?.name}
                </div>
              ...
              <div className="mt-auto text-center flex items-center justify-center gap-2 opacity-[0.2]">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest lowercase">wenden</span>
              </div>
            </div>
            ...
            >
              <div className="flex items-center justify-between mb-auto">
                <div className="px-5 py-2 bg-[#8B1E1E]/10 text-[#8B1E1E] text-[10px] font-black uppercase tracking-widest rounded-full lowercase">die antwort</div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8" onClick={e => e.stopPropagation()}>
                <button 
                   ...
                   className="py-4 bg-[#E2E8D4] text-[#8B1E1E] rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-[#8B1E1E]/10 transition-all shadow-sm lowercase"
                >
                   wiederholen
                </button>
                <button 
                   onClick={() => handleReview(5)} 
                   className="py-4 bg-[#8B1E1E] text-white rounded-2xl font-bold text-xs uppercase tracking-widest shadow-xl shadow-[#8B1E1E]/20 lowercase"
                >
                   gewusst!
                </button>
              </div>
